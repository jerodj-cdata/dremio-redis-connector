...
@SourceType(value = "RedisARP", label = "Redis",uiConfig = "redis-layout.json")
public class RedisConf extends AbstractArpConf<RedisConf> {
  private static final String ARP_FILENAME = "arp/implementation/redis-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.redis.RedisDriver";
